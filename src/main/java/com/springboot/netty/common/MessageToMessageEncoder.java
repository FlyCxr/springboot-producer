...
public abstract class MessageToMessageEncoder<T> extends ChannelOutboundHandlerAdapter {
    ...
    protected MessageToMessageEncoder() {
        this.matcher = TypeParameterMatcher.find(this, io.netty.handler.codec.MessageToMessageEncoder.class, "I");
    }

    protected MessageToMessageEncoder(Class<T> outboundMessageType) {
    ...
    protected abstract void encode(ChannelHandlerContext var1, T var2, List<Object> var3) throws Exception;
}
